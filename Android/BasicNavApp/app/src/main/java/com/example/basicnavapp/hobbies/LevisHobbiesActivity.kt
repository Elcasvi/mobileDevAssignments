...
class LevisHobbiesActivity : ComponentActivity() {
    ...
    fun myImage1(){
        ...
        Image(
            painter = painterResource(R.drawable.chess),
    ...
    fun ListHobbies(){
        Column (horizontalAlignment = Alignment.CenterHorizontally){
            ...
            LazyColumn(horizontalAlignment = Alignment.CenterHorizontally){
                item {
                    ListRow(id = R.drawable.calesthenics, text = "Calisthenics")
                    ListRow(id = R.drawable.webdev, text = "Web Development")
